...
return [
    ...
    'meta' => [
        ...
        'description' => 'Nothing is impossible. Powered By PJ Blog.'
    ],
    ...
    'footer' => [
        'github' => [
            'open' => true,
            'url'  => 'https://github.com/TongReG/blog',
        ],
        'twitter' => [
            'open' => true,
            'url'  => 'https://twitter.com/tongruitr3'
        ],
        'meta' => '© Zerofreeze Blog Powered By PJ Blog.',
    ],
